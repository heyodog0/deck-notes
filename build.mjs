...
//
// Flags: --slides <dir> --figs <dir> --out <dir> --title "<archive title>"
...
const NOTES_CONFIG = join(PROJECT, 'notes-config.js');
...
// guarded by anonymous auth (see tools/notes/firestore.rules).
